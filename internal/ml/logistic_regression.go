...
// LogisticRegression es un clasificador binario simple para high_demand.
type LogisticRegression struct {
	Weights []float64 `json:"weights"`
	Bias    float64   `json:"bias"`
}

// TrainConfig configura el entrenamiento paralelo.
...
// IterationMetric conserva evidencia del entrenamiento por iteracion.
type IterationMetric struct {
	Iteration int     `json:"iteration"`
	Loss      float64 `json:"loss"`
}

// TrainReport resume el entrenamiento.
...
// TrainParallel entrena regresion logistica dividiendo el calculo de gradientes
// entre goroutines. Cada worker calcula gradientes locales y el coordinador los reduce.
...
// PredictProbability devuelve P(high_demand=1).
...
// PredictLabel clasifica usando umbral 0.5.
...
// PredictBatch predice una lista de muestras.
...
// ActualLabels extrae las etiquetas reales.
